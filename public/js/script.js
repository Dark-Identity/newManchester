...
for (country of countries) {
    ...
    <li class="option">
        <div>
            ...
            <span class="country-name" style = "display:none;">${country.name}</span>
        </div>
        <strong style="color:#fff">+${country.phone}</strong>
    </li> `;
...
function otp_field () {
    document.querySelector('.van-field__right-icon > button').style.display = "none";
    document.querySelector('.email_btn').style.display = "block";
}